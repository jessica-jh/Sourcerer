...
As a researcher, I kept hitting the same wall while writing a literature review: I'd type a sentence, feel certain I'd read that exact claim somewhere in my own pile of PDFs, and have no idea which paper it was actually in. 😩 So I'd go try the obvious fixes, and none of them really solved it.
